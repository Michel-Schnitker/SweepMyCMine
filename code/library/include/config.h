...
#define TUI_SCORE_KEY_SAVE 's'
#define TUI_SCORE_KEY_RESET 'r'

#define TUI_CONFIG_KEY_SELECT_UP KEY_UP
#define TUI_CONFIG_KEY_SELECT_DOWN KEY_DOWN
#define TUI_CONFIG_KEY_SAVE 's'
#define TUI_CONFIG_KEY_RESET 'r'
